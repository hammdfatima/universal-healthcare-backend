...
export const AUDIT_ACTIONS = {
  ...
  BREACH_INCIDENT_CREATED: 'BREACH_INCIDENT_CREATED',
  BREACH_INCIDENT_UPDATED: 'BREACH_INCIDENT_UPDATED',
  BREACH_INCIDENT_DELETED: 'BREACH_INCIDENT_DELETED',
} as const
