...
export const petSchema = z
  .object({
    ...
    emergencyVeterinaryClinic: z.string().nullable(),
    emergencyVeterinaryPhone: z.string().nullable(),
...
export const createPetBodySchema = z
  .object({
    ...
    emergencyVeterinaryClinic: z.string().optional().default(''),
    emergencyVeterinaryPhone: z.string().optional().default(''),
